...
import { NavigationProp } from '@react-navigation/native'; // Assuming you are using React Navigation
    ...
    <View>
      ...
      <View style={{ position: 'absolute', paddingVertical: 20, paddingHorizontal: 10 }}>
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 100 }}>
          ...
          <Text style={{ color: 'white', fontSize: 25, paddingHorizontal: 10, marginTop: 90, marginBottom: 20 }}>
            My Locations
          </Text>
          <FlatList 
            horizontal
